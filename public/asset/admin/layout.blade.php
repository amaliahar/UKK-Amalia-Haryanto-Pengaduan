...
<head>
  ...
  <link rel="shortcut icon" href="../../asset/template/images/logo-wk.png" /> 
        ...
        <div class="navbar-menu-wrapper d-flex align-items-top"> 
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
              <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold">@auth {{ Auth::user()->name }} @endauth</span></h1>
