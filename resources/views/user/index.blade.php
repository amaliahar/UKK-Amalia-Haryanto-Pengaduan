          ...
          <div class="cs-main_header_center">
            <div class="cs-nav">
              <ul class="cs-nav_list">
                ...
                <li><a href="{{ url('pengaduans')}}" class="cs-smoth_scroll">Pengaduan</a></li>
    ...
    <section class="cs-hero cs-style1 cs-bg" data-src="asset/posing/assets/img/hero_bg.svg">
      <div class="container">
        ...
        <div class="cs-hero_text">
          ...
          <h1 class="cs-hero_title">Selamat datang di Pengajuan Masyarakat <br></h1>
...
<div class="main-panel">
   ...
   <!-- Start Fun Fact -->
   <div class="padding-tb section-bg">
            ...
            <div class="cs-funfact_1_wrap cs-type1">
                <div class="row flex-row-reverse col-lg-11">
                    <div class="container section-wrapper">
                        ...
                        <div class="col-xl-8 col-lg-7 col-12 grid-margin stretch-card">
                        <div class="card" style="left:230px">
                            <div class="card-body">
                                <h4 class="card-title">Sampaikan Pengaduan Anda</h4>
                                <p class="card-description">Gunakan bahasa yang baik dan benar</p>
                        ...
                        <br>
                        <div class="col-xl-6 col-lg-7 col-12 grid-margin grid-margin-md-6    stretch-card">
                            <div class="card" style="left: 430px">
                                <div class="card-body text-center">
                                    <div>
                                        <img src="asset/image_11.jpg" class="img-lg rounded-circle mb-2" alt="profile">
                                    ...
                                    <button class="btn btn-info btn-sm mt-3 mb-4" fdprocessedid="cpzrm">Follow</button> --}}
      ...
      <div class="cs-modal_container cs-white_bg">
        ...
        <div class="cs-login">
          <div class="cs-login_left">
            <img src="asset/image_1.webp" alt="Login Thumb">
          </div>
          <div class="cs-login_right">
            <form class="cs-login_form">
              <h2>Login in to your posing account</h2>
              <div class="cs-height_30 cs-height_lg_30"></div>
              <input type="text" class="cs-form_field cs-border_color" placeholder="Nama Pengguna">
              <div class="cs-height_20 cs-height_lg_20"></div>
              <input type="password" class="cs-form_field cs-border_color" placeholder="Kata Sandi">
              <div class="cs-height_20 cs-height_lg_20"></div>
              ...
              <p class="cs-m0">
                Tidak memiliki akun?
                <span class="cs-text_btn cs-modal_btn" data-modal="register"><span>Silahkan Daftar</span></span>
              </p>
              <div class="cs-height_30 cs-height_lg_30"></div>
        ...
        <div class="cs-login">
          ...
          <div class="cs-login_right">
            <form class="cs-login_form" >
              ...
              <div class="cs-height_30 cs-height_lg_30"></div>
              <input type="text" class="cs-form_field cs-border_color" placeholder="Nama">
              <div class="cs-height_20 cs-height_lg_20"></div>
              <input type="text" class="cs-form_field cs-border_color" placeholder="Nama Pengguna">
              <div class="cs-height_20 cs-height_lg_20"></div>
              ...
              <div class="cs-height_20 cs-height_lg_20"></div>
              <input type="password" class="cs-form_field cs-border_color" placeholder="Kata Sandi">
              <div class="cs-height_20 cs-height_lg_20">
              <input type="text" value="{{ old('telp') }}" name="telp" class="cs-form_field cs-border_color @error('telp') is-invalid @enderror" id="telp" placeholder="Telp">
                @error('telp')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="cs-height_20 cs-height_lg_20"></div>
              <button class="cs-btn cs-size_md w-100"><span>{{ __('Daftar')}}</span></button>
              <div class="cs-height_20 cs-height_lg_20"></div>
              <p class="cs-m0">
