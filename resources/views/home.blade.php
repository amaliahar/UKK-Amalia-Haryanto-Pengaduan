...
<head>
  ...
  <!-- Favicon Icon -->
  <link rel="icon" href="asset/posing/assets/img/favicon.png">
  <!-- Site Title -->
  <title>Posing Landing Page</title>
  <link rel="stylesheet" href="asset/posing/assets/css/plugins/bootstrap.min.css">
  <link rel="stylesheet" href="asset/posing/assets/css/plugins/slick.css">
  <link rel="stylesheet" href="asset/posing/assets/css/plugins/animate.css">
  <link rel="stylesheet" href="asset/posing/assets/css/style.css">
</head>

<body>
  <div class="cs-preloader cs-white_bg cs-center">
    <div class="cs-preloader_in">
      <img src="asset/posing/assets/img/logo_mini.svg" alt="Logo">
    </div>
  </div>
        ...
        <div class="cs-main_header_in">
          <div class="cs-main_header_left">
            {{-- <a class="cs-site_branding cs-accent_color" href="index.html">
              <img src="asset/posing/assets/img/logo.svg" alt="Logo">
            </a> --}}
          </div>
  ...
  <div id="home">
    ...
    <section class="cs-hero cs-style1 cs-bg" data-src="asset/posing/assets/img/hero_bg.svg">
      <div class="container">
        <div class="cs-hero_img">
          <div class="cs-hero_img_bg cs-bg" data-src="asset/posing/assets/img/hero_img_bg.png"></div>
          {{-- <img src="" alt="Hero Image" class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.4s"> --}}
        </div>
        ...
        <div class="cs-hero_shapes">
          <div class="cs-shape cs-shape_position1">
            <img src="asset/posing/assets/img/shape/shape_1.svg" alt="Shape">
          </div>
          <div class="cs-shape cs-shape_position2">
            <img src="asset/posing/assets/img/shape/shape_2.svg" alt="Shape">
          </div>
          <div class="cs-shape cs-shape_position3">
            <img src="asset/posing/assets/img/shape/shape_3.svg" alt="Shape">
          </div>
          <div class="cs-shape cs-shape_position4">
            <img src="asset/posing/assets/img/shape/shape_4.svg" alt="Shape">
          </div>
          <div class="cs-shape cs-shape_position5">
            <img src="asset/posing/assets/img/shape/shape_5.svg" alt="Shape">
          </div>
          <div class="cs-shape cs-shape_position6">
            <img src="asset/posing/assets/img/shape/shape_6.svg" alt="Shape">
          </div>
        </div>
      </div>
    </section>
  ...
  <!-- Start Main Feature -->
  <section class="cs-bg" id="about" data-src="asset/posing/assets/img/feature_bg.svg">
    ...
    <div class="container">
      <div class="cs-seciton_heading cs-style1 text-center">
        ...
        <h3 class="cs-section_title">Simak Penjelasan dibawah ini</h3>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 col-xl-3">
          ...
          <div class="cs-iconbox cs-style1">
            <div class="cs-iconbox_icon cs-center">
              <img src="asset/posing/assets/img/icons/icon_box_1.svg" alt="Icon">
            </div>
            <div class="cs-iconbox_in">
              <div class="cs-iconbox_number cs-primary_font">01</div>
              <h3 class="cs-iconbox_title"></h3>
              <div class="cs-iconbox_subtitle">Laporan keluhan atau aspirasi anda dengan sejenisnya dan lengkap</div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="cs-iconbox cs-style1">
            <div class="cs-iconbox_icon cs-center">
              <img src="asset/posing/assets/img/icons/icon_box_2.svg" alt="Icon">
            </div>
            <div class="cs-iconbox_in">
              <div class="cs-iconbox_number cs-primary_font">02</div>
              <h3 class="cs-iconbox_title">Tindak Lanjut</h3>
              <div class="cs-iconbox_subtitle">Instansi akan menindaklanjuti dan membalas laporan Anda</div>
            </div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
        </div>
        <div class="col-md-6 col-xl-3">
          ...
          <div class="cs-iconbox cs-style1">
            <div class="cs-iconbox_icon cs-center">
              <img src="asset/posing/assets/img/icons/icon_box_3.svg" alt="Icon">
            </div>
            <div class="cs-iconbox_in">
              <div class="cs-iconbox_number cs-primary_font">03</div>
              <h3 class="cs-iconbox_title">Beri Tanggapan</h3>
              <div class="cs-iconbox_subtitle">Pihak kami akan menanggapi laporan yang telah anda ajukan</div>
            </div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="cs-iconbox cs-style1">
            <div class="cs-iconbox_icon cs-center">
              <img src="asset/posing/assets/img/icons/icon_box_4.svg" alt="Icon">
            </div>
            <div class="cs-iconbox_in">
              <div class="cs-iconbox_number cs-primary_font">04</div>
              <h3 class="cs-iconbox_title">Selesai</h3>
              <div class="cs-iconbox_subtitle">Laporan Anda akan terus ditindaklanjuti hingga terselesaikan</div>
            </div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
        </div>
        ...
        <div class="col-xl-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="cs-left_full_width cs-space110">
            <div class="cs-left_sided_img">
              <img src="asset/posing/assets/img/about_img_1.png" alt="About">
            </div>
          </div>
        </div>
        <div class="col-xl-6">
          ...
          <div class="cs-list_1_wrap">
            <ul class="cs-list cs-style1 cs-mp0">
              <li>
                <span class="cs-list_icon">
                  <img src="asset/posing/assets/img/icons/tick.svg" alt="Tick">
                </span>
            ...
            <div class="cs-list_img wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s"><img src="asset/posing/assets/img/about_img_2.png" alt="About"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid">
    ...
    <div class="cs-funfact_1_wrap cs-type1">
      <div class="cs-funfact cs-style1">
        <div class="cs-funfact_icon cs-center"><img src="asset/posing/assets/img/icons/funfact_icon_1.svg" alt="Icon"></div>
        <div class="cs-funfact_right">
          <div class="cs-funfact_number cs-primary_font"><span data-count-to="320" class="odometer"></span>+</div>
          <h2 class="cs-funfact_title">Proses</h2>
        </div>
      </div>
      <div class="cs-funfact cs-style1">
        <div class="cs-funfact_icon cs-center"><img src="asset/posing/assets/img/icons/funfact_icon_2.svg" alt="Icon"></div>
        <div class="cs-funfact_right">
          <div class="cs-funfact_number cs-primary_font"><span data-count-to="92" class="odometer"></span>k</div>
          <h2 class="cs-funfact_title">Tanggapan</h2>
        </div>
      </div>
      <div class="cs-funfact cs-style1">
        <div class="cs-funfact_icon cs-center"><img src="asset/posing/assets/img/icons/funfact_icon_3.svg" alt="Icon"></div>
        <div class="cs-funfact_right">
          <div class="cs-funfact_number cs-primary_font"><span data-count-to="5" class="odometer"></span>k</div>
          <h2 class="cs-funfact_title">Pengaduan</h2>
        </div>
      </div>
      <div class="cs-funfact cs-style1">
        <div class="cs-funfact_icon cs-center"><img src="asset/posing/assets/img/icons/funfact_icon_4.svg" alt="Icon"></div>
        <div class="cs-funfact_right">
          <div class="cs-funfact_number cs-primary_font"><span data-count-to="20" class="odometer"></span>+</div>
          <h2 class="cs-funfact_title">Selesai</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- Start All Feature -->
  {{-- <section class="cs-bg" data-src="asset/posing/assets/img/feature_bg.svg">
    <div class="cs-height_135 cs-height_lg_0"></div>
    <div id="feature">
      <div class="cs-height_95 cs-height_lg_70"></div>
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              <div class="cs-iconbox_icon cs-center">
                <img src="asset/posing/assets/img/icons/icon_box_5.svg" alt="Icon">
              </div>
              <div class="cs-iconbox_in">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              <div class="cs-iconbox_icon cs-center">
                <img src="asset/posing/assets/img/icons/icon_box_6.svg" alt="Icon">
              </div>
              <div class="cs-iconbox_in">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              <div class="cs-iconbox_icon cs-center">
                <img src="asset/posing/assets/img/icons/icon_box_7.svg" alt="Icon">
              </div>
              <div class="cs-iconbox_in">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              <div class="cs-iconbox_icon cs-center">
                <img src="asset/posing/assets/img/icons/icon_box_8.svg" alt="Icon">
              </div>
              <div class="cs-iconbox_in">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              <div class="cs-iconbox_icon cs-center">
                <img src="asset/posing/assets/img/icons/icon_box_9.svg" alt="Icon">
              </div>
              <div class="cs-iconbox_in">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              <div class="cs-iconbox_icon cs-center">
                <img src="asset/posing/assets/img/icons/icon_box_10.svg" alt="Icon">
              </div>
              <div class="cs-iconbox_in">
      ...
      <div class="row align-items-center flex-column-reverse-lg">
        <div class="col-xl-6">
          <div class="cs-left_full_width cs-space40">
            <div class="cs-left_sided_img">
              <img src="asset/posing/assets/img/retail-store.png" alt="Retail Stores">
            </div>
          </div>
        </div>
        <div class="col-xl-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    <div class="cs-iconbox_icon"><img src="asset/posing/assets/img/icons/retail_icon_1.svg" alt="Icon"></div>
                ...
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    <div class="cs-iconbox_icon"><img src="asset/posing/assets/img/icons/retail_icon_2.svg" alt="Icon"></div>
          ...
          <div class="row wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
            <div class="col-lg-11">
              <div class="row">
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    <div class="cs-iconbox_icon"><img src="asset/posing/assets/img/icons/retail_icon_3.svg" alt="Icon"></div>
                ...
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    <div class="cs-iconbox_icon"><img src="asset/posing/assets/img/icons/retail_icon_4.svg" alt="Icon"></div>
          ...
          <div class="row wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
            <div class="col-lg-11 offset-lg-1">
              <div class="row">
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    <div class="cs-iconbox_icon"><img src="asset/posing/assets/img/icons/retail_icon_5.svg" alt="Icon"></div>
                ...
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    <div class="cs-iconbox_icon"><img src="asset/posing/assets/img/icons/retail_icon_6.svg" alt="Icon"></div>
  ...
  <!-- Start Price Section -->
  {{-- <section class="cs-bg" data-src="asset/posing/assets/img/feature_bg.svg" id="pricing">
    <div class="cs-height_95 cs-height_lg_70"></div>
    <div class="container">
      <div class="cs-seciton_heading cs-style1 text-center">
      ...
      <div class="row">
          ...
          <div class="cs-pricing_table cs-style1">
            <div class="cs-pricing_head">
              <div class="cs-pricing_heading">
                <div class="cs-pricing_icon cs-center"><img src="asset/posing/assets/img/icons/pricing_icon_1.svg" alt="Icon"></div>
        ...
        <div class="col-lg-4">
          <div class="cs-pricing_table cs-style1">
            <div class="cs-pricing_head">
              <div class="cs-pricing_heading">
                <div class="cs-pricing_icon cs-center"><img src="asset/posing/assets/img/icons/pricing_icon_2.svg" alt="Icon"></div>
        ...
        <div class="col-lg-4">
          <div class="cs-pricing_table cs-style1">
            <div class="cs-pricing_head">
              <div class="cs-pricing_heading">
                <div class="cs-pricing_icon cs-center"><img src="asset/posing/assets/img/icons/pricing_icon_3.svg" alt="Icon"></div>
          ...
          <div class="cs-slider_wrapper">
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_meta">
                  <div class="cs-avatar">
                    <img src="asset/posing/assets/img/avatar_1.png" alt="Avatar">
                  ...
                  <div class="cs-testimonial_meta_right">
                    ...
                    <div class="cs-review" data-review="4">
                      <img src="asset/posing/assets/img/icons/stars.svg" alt="Star">
            ...
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_meta">
                  <div class="cs-avatar">
                    <img src="asset/posing/assets/img/avatar_2.png" alt="Avatar">
                    <div class="cs-quote cs-center">
                      <svg width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9033 0.470251C17.974 0.470231 18.0431 0.492568 18.1019 0.534429C18.1606 0.576288 18.2064 0.635782 18.2333 0.705356L18.9732 2.62083C19.0075 2.70954 19.0089 2.80875 18.9772 2.89853C18.9455 2.98831 18.8831 3.06201 18.8024 3.1048C17.5346 3.77738 16.6023 4.83665 16.0311 6.25297C15.8289 6.75453 15.6825 7.27956 15.595 7.81733L17.569 7.81733C17.6636 7.81733 17.7544 7.85732 17.8213 7.92851C17.8882 7.9997 17.9258 8.09624 17.9258 8.19692L17.9258 14.6207C17.9258 14.7213 17.8882 14.8179 17.8213 14.8891C17.7544 14.9603 17.6636 15.0002 17.569 15.0002L10.2806 15.0002C10.1859 15.0002 10.0952 14.9603 10.0283 14.8891C9.96136 14.8179 9.92377 14.7213 9.92377 14.6207L9.92377 10.2215C9.92329 8.5455 10.3244 6.897 11.0891 5.4317C11.8539 3.9664 12.9571 2.73265 14.2946 1.84695C15.2002 1.24811 16.1969 0.821584 17.24 0.586498C17.6221 0.499905 17.8567 0.473809 17.8665 0.472623C17.8787 0.47112 17.891 0.470328 17.9033 0.470251ZM18.19 2.59094L17.6794 1.26856C17.5984 1.28351 17.501 1.3032 17.3895 1.32859C13.4762 2.2142 10.6374 5.95429 10.6374 10.2215L10.6374 14.2411L17.2122 14.2411L17.2122 8.5765L15.1902 8.5765C15.1417 8.57658 15.0936 8.56612 15.049 8.54576C15.0044 8.52541 14.9642 8.49559 14.9308 8.45813C14.8974 8.42066 14.8715 8.37634 14.8548 8.32788C14.838 8.27942 14.8308 8.22783 14.8334 8.17628C14.8354 8.13571 14.8892 7.17133 15.3635 5.98228C15.6341 5.29767 16.0027 4.66176 16.4562 4.09717C16.9467 3.49086 17.5336 2.98102 18.19 2.59094Z" fill="currentColor"/>
                        <path d="M8.42661 0.470251C8.4973 0.470278 8.56638 0.492638 8.6251 0.534494C8.68382 0.576352 8.72953 0.635819 8.75643 0.705356L9.49636 2.62083C9.53062 2.70954 9.53205 2.80875 9.50036 2.89853C9.46867 2.98831 9.40621 3.06201 9.32554 3.1048C8.05777 3.77738 7.12539 4.83665 6.55428 6.25297C6.3522 6.75461 6.20582 7.27961 6.11809 7.81733L8.09211 7.81733C8.18674 7.81733 8.27749 7.85732 8.34441 7.92851C8.41132 7.9997 8.44891 8.09624 8.44891 8.19692L8.44891 14.6207C8.44891 14.7213 8.41132 14.8179 8.34441 14.8891C8.27749 14.9603 8.18674 15.0002 8.09211 15.0002L0.802814 15.0002C0.708182 15.0002 0.617428 14.9603 0.550514 14.8891C0.483601 14.8179 0.446009 14.7213 0.446009 14.6207L0.446009 10.2215C0.442028 7.96623 1.16694 5.77803 2.49922 4.02375C3.8315 2.26946 5.69016 1.05573 7.76363 0.586024C8.14563 0.499431 8.38001 0.473334 8.38982 0.472148C8.40204 0.470806 8.41432 0.470174 8.42661 0.470251ZM8.71339 2.59094L8.2025 1.26856C8.12177 1.28351 8.02409 1.3032 7.91259 1.32859C3.99934 2.2142 1.15962 5.95429 1.15962 10.2215L1.15962 14.2411L7.7353 14.2411L7.7353 8.5765L5.71334 8.5765C5.6648 8.57658 5.61676 8.56612 5.57216 8.54576C5.52755 8.52541 5.48732 8.49559 5.45392 8.45813C5.42052 8.42066 5.39466 8.37634 5.37791 8.32788C5.36117 8.27942 5.35389 8.22783 5.35653 8.17628C5.35854 8.13571 5.41251 7.17133 5.88661 5.98228C6.15719 5.29767 6.5258 4.66177 6.97932 4.09717C7.46979 3.49073 8.05677 2.98087 8.71339 2.59094Z" fill="currentColor"/>
            ...
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_meta">
                  <div class="cs-avatar">
                    <img src="asset/posing/assets/img/avatar_3.png" alt="Avatar">
                    <div class="cs-quote cs-center">
                      <svg width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9033 0.470251C17.974 0.470231 18.0431 0.492568 18.1019 0.534429C18.1606 0.576288 18.2064 0.635782 18.2333 0.705356L18.9732 2.62083C19.0075 2.70954 19.0089 2.80875 18.9772 2.89853C18.9455 2.98831 18.8831 3.06201 18.8024 3.1048C17.5346 3.77738 16.6023 4.83665 16.0311 6.25297C15.8289 6.75453 15.6825 7.27956 15.595 7.81733L17.569 7.81733C17.6636 7.81733 17.7544 7.85732 17.8213 7.92851C17.8882 7.9997 17.9258 8.09624 17.9258 8.19692L17.9258 14.6207C17.9258 14.7213 17.8882 14.8179 17.8213 14.8891C17.7544 14.9603 17.6636 15.0002 17.569 15.0002L10.2806 15.0002C10.1859 15.0002 10.0952 14.9603 10.0283 14.8891C9.96136 14.8179 9.92377 14.7213 9.92377 14.6207L9.92377 10.2215C9.92329 8.5455 10.3244 6.897 11.0891 5.4317C11.8539 3.9664 12.9571 2.73265 14.2946 1.84695C15.2002 1.24811 16.1969 0.821584 17.24 0.586498C17.6221 0.499905 17.8567 0.473809 17.8665 0.472623C17.8787 0.47112 17.891 0.470328 17.9033 0.470251ZM18.19 2.59094L17.6794 1.26856C17.5984 1.28351 17.501 1.3032 17.3895 1.32859C13.4762 2.2142 10.6374 5.95429 10.6374 10.2215L10.6374 14.2411L17.2122 14.2411L17.2122 8.5765L15.1902 8.5765C15.1417 8.57658 15.0936 8.56612 15.049 8.54576C15.0044 8.52541 14.9642 8.49559 14.9308 8.45813C14.8974 8.42066 14.8715 8.37634 14.8548 8.32788C14.838 8.27942 14.8308 8.22783 14.8334 8.17628C14.8354 8.13571 14.8892 7.17133 15.3635 5.98228C15.6341 5.29767 16.0027 4.66176 16.4562 4.09717C16.9467 3.49086 17.5336 2.98102 18.19 2.59094Z" fill="currentColor"/>
                        <path d="M8.42661 0.470251C8.4973 0.470278 8.56638 0.492638 8.6251 0.534494C8.68382 0.576352 8.72953 0.635819 8.75643 0.705356L9.49636 2.62083C9.53062 2.70954 9.53205 2.80875 9.50036 2.89853C9.46867 2.98831 9.40621 3.06201 9.32554 3.1048C8.05777 3.77738 7.12539 4.83665 6.55428 6.25297C6.3522 6.75461 6.20582 7.27961 6.11809 7.81733L8.09211 7.81733C8.18674 7.81733 8.27749 7.85732 8.34441 7.92851C8.41132 7.9997 8.44891 8.09624 8.44891 8.19692L8.44891 14.6207C8.44891 14.7213 8.41132 14.8179 8.34441 14.8891C8.27749 14.9603 8.18674 15.0002 8.09211 15.0002L0.802814 15.0002C0.708182 15.0002 0.617428 14.9603 0.550514 14.8891C0.483601 14.8179 0.446009 14.7213 0.446009 14.6207L0.446009 10.2215C0.442028 7.96623 1.16694 5.77803 2.49922 4.02375C3.8315 2.26946 5.69016 1.05573 7.76363 0.586024C8.14563 0.499431 8.38001 0.473334 8.38982 0.472148C8.40204 0.470806 8.41432 0.470174 8.42661 0.470251ZM8.71339 2.59094L8.2025 1.26856C8.12177 1.28351 8.02409 1.3032 7.91259 1.32859C3.99934 2.2142 1.15962 5.95429 1.15962 10.2215L1.15962 14.2411L7.7353 14.2411L7.7353 8.5765L5.71334 8.5765C5.6648 8.57658 5.61676 8.56612 5.57216 8.54576C5.52755 8.52541 5.48732 8.49559 5.45392 8.45813C5.42052 8.42066 5.39466 8.37634 5.37791 8.32788C5.36117 8.27942 5.35389 8.22783 5.35653 8.17628C5.35854 8.13571 5.41251 7.17133 5.88661 5.98228C6.15719 5.29767 6.5258 4.66177 6.97932 4.09717C7.46979 3.49073 8.05677 2.98087 8.71339 2.59094Z" fill="currentColor"/>
          ...
          <div class="cs-slider_wrapper">
            <div class="cs-slide">
              <div class="cs-client cs-accent_bg cs-center">
                <img src="asset/posing/assets/img/client_1.svg" alt="Client">
              </div>
            </div><!-- .cs-slide -->
            <div class="cs-slide">
              <div class="cs-client cs-accent_bg cs-center">
                <img src="asset/posing/assets/img/client_2.svg" alt="Client">
              </div>
            </div><!-- .cs-slide -->
            <div class="cs-slide">
              <div class="cs-client cs-accent_bg cs-center">
                <img src="asset/posing/assets/img/client_3.svg" alt="Client">
              </div>
            </div><!-- .cs-slide -->
            <div class="cs-slide">
              <div class="cs-client cs-accent_bg cs-center">
                <img src="asset/posing/assets/img/client_4.svg" alt="Client">
              </div>
            </div><!-- .cs-slide -->
            <div class="cs-slide">
              <div class="cs-client cs-accent_bg cs-center">
                <img src="asset/posing/assets/img/client_5.svg" alt="Client">
              </div>
            </div><!-- .cs-slide -->
            <div class="cs-slide">
              <div class="cs-client cs-accent_bg cs-center">
                <img src="asset/posing/assets/img/client_6.svg" alt="Client">
              </div>
            </div><!-- .cs-slide -->
            <div class="cs-slide">
              <div class="cs-client cs-accent_bg cs-center">
    ...
    <div class="container">
      <div class="row align-items-center flex-column-reverse-lg">
        <div class="col-xl-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
          <div class="cs-left_full_width cs-space110">
            <div class="cs-left_sided_img">
              <img src="asset/posing/assets/img/faq_img.png" alt="About">
            </div>
          </div>
          <div class="cs-height_0 cs-height_lg_40"></div>
        </div>
  ...
  <!-- Start unntuk berita Section -->
  <section class="cs-bg" data-src="asset/posing/assets/img/feature_bg.svg" id="news">
    ...
    <div class="container">
      <div class="cs-seciton_heading cs-style1 text-center">
        ...
        <div class="cs-height_10 cs-height_lg_10"></div>
        <h3 class="cs-section_title">Data Laporan Terkini</h3>
      </div>
      <div class="cs-height_50 cs-height_lg_40"></div>
      <div class="cs-slider cs-style1 cs-gap-24">
          ...
          <div class="cs-slider_wrapper">
            <div class="cs-slide">
              <div class="cs-post cs-style1">
                <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="asset/posing/assets/img/post_1.jpeg"></div></div>
            ...
            <div class="cs-slide">
              <div class="cs-post cs-style1">
                <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="asset/posing/assets/img/post_2.jpeg"></div></div>
                <div class="cs-post_info">
                  <ul class="cs-post_meta cs-mp0">
                    <li>
                      <span class="cs-medium">
            ...
            <div class="cs-slide">
              <div class="cs-post cs-style1">
                <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="asset/posing/assets/img/post_3.jpeg"></div></div>
                <div class="cs-post_info">
                  <ul class="cs-post_meta cs-mp0">
                    <li>
                      <span class="cs-medium">
            ...
            <div class="cs-slide">
              <div class="cs-post cs-style1">
                <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="asset/posing/assets/img/post_4.jpeg"></div></div>
                <div class="cs-post_info">
                  <ul class="cs-post_meta cs-mp0">
                    <li>
                      <span class="cs-medium">
        ...
        <div class="col-xl-5 col-lg-8">
          ...
          <div class="cs-iconbox cs-style3">
            <div class="cs-iconbox_icon">
              <img src="asset/posing/assets/img/icons/contact_icon_1.svg" alt="Icon">
            </div>
          ...
          <div class="cs-iconbox cs-style3">
            <div class="cs-iconbox_icon">
              <img src="asset/posing/assets/img/icons/contact_icon_2.svg" alt="Icon">
            </div>
            <div class="cs-iconbox_right">
          ...
          <div class="cs-iconbox cs-style3">
            <div class="cs-iconbox_icon">
              <img src="asset/posing/assets/img/icons/contact_icon_3.svg" alt="Icon">
            </div>
            <div class="cs-iconbox_right">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="cs-footer_item">
            <div class="cs-footer_widget_text">
              <img src="asset/posing/assets/img/logo_footer.svg" alt="Logo">
              <p>
                Webiste Pengaduan Masyarakat <br>
                Kecamatan Ciawi <br>
            ...
            <div class="cs-social_btns cs-style1">
              <a href="#"><img src="asset/posing/assets/img/facebook.svg" alt="Facebook"></a>
              <a href="#"><img src="asset/posing/assets/img/twitter.svg" alt="Twitter"></a>
              <a href="#"><img src="asset/posing/assets/img/instagram.svg" alt="Instagram"></a>
            </div>
          </div>
        </div><!-- .col -->
        {{-- <div class="col-lg-3 col-md-6">
      ...
      <div class="cs-modal_container cs-white_bg">
        ...
        <div class="cs-login">
          <div class="cs-login_left">
            <img src="asset/posing/assets/img/about_img_1.png" alt="Login Thumb">
          </div>
          <div class="cs-login_right">
            <form class="cs-login_form">
              ...
              <div class="cs-height_20 cs-height_lg_20"></div>
              <button class="cs-btn cs-size_md w-100"><span>Masuk</span></button>
              <div class="cs-height_20 cs-height_lg_20"></div>
              <p class="cs-m0">
                Don't have an account?
                <span class="cs-text_btn cs-modal_btn" data-modal="register"><span>Daftar</span></span>
              </p>
              <div class="cs-height_30 cs-height_lg_30"></div>
  ...
  <div class="cs-modal" data-modal="register">
    ...
    <div class="cs-modal_in">
      <div class="cs-modal_container cs-white_bg">
        ...
        <div class="cs-login">
          <div class="cs-login_left">
            <img src="asset/posing/assets/img/retail-store.png" alt="Login Thumb">
          </div>
          <div class="cs-login_right">
            <form class="cs-login_form">
              ...
              <p class="cs-m0">
                ...
                <span class="cs-text_btn cs-modal_btn" data-modal="login"><span>Masuk</span></span>
              </p>
              <div class="cs-height_30 cs-height_lg_30"></div>
              <div class="cs-or"><span>or</span></div>
              <div class="cs-height_40 cs-height_lg_30"></div>
    ...
    <div class="cs-modal_in">
      <div class="cs-modal_container cs-white_bg">
        ...
        <div class="cs-blog_details">
          ...
          <img src="asset/posing/assets/img/post_details_1.jpeg" alt="Details" class="cs-radius_10 w-100">
          ...
          {{-- <div class="row">
            <div class="col-lg-6">
              <img src="asset/posing/assets/img/post_details_2.jpeg" alt="Details" class="cs-radius_10 w-100">
            </div>
            <div class="col-lg-6">
              <img src="asset/posing/assets/img/post_details_3.jpeg" alt="Details" class="cs-radius_10 w-100">
            </div>
          </div> --}}
          ...
          {{-- <div class="row">
            ...
            <div class="col-lg-6">
              <img src="asset/posing/assets/img/post_details_4.jpeg" alt="Details" class="cs-radius_10 w-100">
            </div>
          </div>
        </div>
          ...
          <div class="cs-comment_wrapper">
            ...
            <ol class="comment-list">
              <li>
                <div class="comment-body">
                  <div class="comment-author">
                    <img alt="Avatar" src="asset/posing/assets/img/avatar_4.png" class="avatar">
                ...
                <ol class="children">
                  <li>
                    <div class="comment-body">
                      <div class="comment-author">
                        <img alt="Avatar" src="asset/posing/assets/img/avatar_5.png" class="avatar">
              ...
              <li>
                <div class="comment-body">
                  <div class="comment-author">
                    <img alt="Avatar" src="asset/posing/assets/img/avatar_6.png" class="avatar">
  ...
  <!-- Script -->
  <script src="asset/posing/assets/js/plugins/jquery-3.6.0.min.js"></script>
  <script src="asset/posing/assets/js/plugins/jquery.slick.min.js"></script>
  <script src="asset/posing/assets/js/plugins/jquery.counter.min.js"></script>
  <script src="asset/posing/assets/js/plugins/wow.min.js"></script>
  <script src="asset/posing/assets/js/main.js"></script>
</body>
</html>
